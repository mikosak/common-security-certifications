...
def extract_and_count(row):
    ...
    to_match = r"\b[A-Z]{4,5}\b|(?<=[a-z])[A-Z]{4,5}|[A-Z][a-z]+?\+|\b[A-Z]{2}\b-\b[0-9]{3}\b|\be[A-Z].*?\b|CEH|CCE|CAP|EnCE|CFR|GSE|CRT"
